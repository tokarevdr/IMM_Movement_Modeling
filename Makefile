#############################################################################
# Makefile for building: IMM_Movement_Modeling
# Generated by qmake (3.0) (Qt 5.4.0)
# Project:  IMM_Movement_Modeling.pro
# Template: subdirs
# Command: C:\Qt\Qt5.4.0\5.4\mingw491_32\bin\qmake.exe -spec win32-g++ CONFIG+=debug -o Makefile IMM_Movement_Modeling.pro
#############################################################################
...
sub-src-main-qmake_all:  FORCE
	...
	cd src\main\ && $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile
	cd src\main\ && $(MAKE) -f Makefile qmake_all
sub-src-main: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile
sub-src-main-make_first: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile 
sub-src-main-all: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile all
sub-src-main-clean: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile clean
sub-src-main-distclean: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile distclean
sub-src-main-install_subtargets: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile install
sub-src-main-uninstall_subtargets: FORCE
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile uninstall

Makefile: IMM_Movement_Modeling.pro C:/Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.4.0/5.4/mingw491_32/mkspecs/features/spec_pre.prf \
		...
		IMM_Movement_Modeling.pro
	$(QMAKE) -spec win32-g++ CONFIG+=debug -o Makefile IMM_Movement_Modeling.pro
...
sub-src-main-debug:
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile debug
debug: sub-src-main-debug

sub-src-main-release:
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile release
release: sub-src-main-release

sub-src-main-check:
	@if not exist src\main\ mkdir src\main\ & if not exist src\main\ exit 1
	cd src\main\ && ( if not exist Makefile $(QMAKE) D:\tokarevdr\Qt_projects\IMM_Movement_Modeling\src\main\main.pro -spec win32-g++ CONFIG+=debug -o Makefile ) && $(MAKE) -f Makefile check
